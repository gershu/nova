#!/usr/bin/env bash
# run.sh — Wrapper fuer modules.llm.portfolio_briefing.
# Generiert taegliches Markdown-Briefing fuer Portfolio.
# Persistiert sig_portfolio_briefings; digest holt's beim naechsten Lauf.
set -euo pipefail
